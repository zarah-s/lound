      ...
      <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        >
          ...
          <div class="absolute  bottom-0 hidden py-5 text-center md:block text-white w-full">
            ...
            {/* <button className="bg-[#ff7d0c] py-3 px-5 rounded-full">
              View More
            </button> */}
          </div>
        </div>
        ...
        >
          ...
          <div class="absolute  bottom-0 hidden py-5 text-center text-white md:block w-full">
            <h5 class="text-5xl font-semibold text-white">Perfect Venue</h5>
            <p className="text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Consectetur commodi,
            </p>
        ...
        >
          ...
          <div className="bg-[#00000033] absolute w-full h-full top-0 "></div>
          <div class="absolute  bottom-0 hidden py-5 text-center md:block  text-white w-full">
            <h5 class="text-5xl font-semibold text-white">Beautiful Layout</h5>
            <p className="text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Consectetur commodi,
            </p>
