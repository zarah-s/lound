    ...
    >
      ...
      <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        >
          ...
          <div class="absolute  bottom-0 hidden py-5 text-center md:block  text-whit w-full">
            ...
            {/* <button className="btn btn-primary sm">View More</button> */}
          </div>
        </div>
        <div
        ...
        >
          ...
          <div class="absolute  bottom-0 hidden py-5 text-center text-white md:block w-full">
            <h5 class="text-5xl font-semibold text-white">Perfect Wash</h5>
            <p className="text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Consectetur commodi, saepe sint iusto, eveniet nobis expedita
              aperiam soluta excepturi aliquid perspiciatis amet exercitationem
        ...
        >
          ...
          <div class="absolute  bottom-0 hidden py-5 text-center md:block  text-whit w-full">
            <h5 class="text-5xl font-semibold text-white">Safe</h5>
            <p className="text-white">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Consectetur commodi, saepe sint iusto, eveniet nobis expedita
              aperiam soluta excepturi aliquid perspiciatis amet exercitationem
